...
dataset = ImageFolder('RGBGREY', transform=transform)
...
def test_loop(dataloader, model):
    ...
    plt.savefig('RESNET18RGBGREY_CM.png', dpi=300, bbox_inches='tight')
...
# Save the model
torch.save(model.state_dict(), 'resnet18RGBGREY.pth')