...
dataset = ImageFolder('Data/H&E_Train', transform=transform)
...
def test_loop(dataloader, model):
    ...
    plt.savefig('RESNET18H&E_CM.png', dpi=300, bbox_inches='tight')
...
# Save the model
torch.save(model.state_dict(), 'resnet18H&E.pth')