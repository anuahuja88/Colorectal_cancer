...
dataset = ImageFolder('Data/RGBH&E', transform=transform)
...
def test_loop(dataloader, model):
    ...
    plt.savefig('Confusion Matrix/RESNET18RGBH&E_CM.png', dpi=300, bbox_inches='tight')
...
# Save the model
torch.save(model.state_dict(), 'Saved/resnet18RGBH&E.pth')